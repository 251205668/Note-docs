...
function getGuideSidebar(group,groupA, groupB, groupC,groupD,groupE,groupF,groupG) {
  return [
    ...
    },
    {
      title: groupG,
      collapsable: true,
      children: ['/guide/interview/test.md','/guide/interview/web-api.md','/guide/interview/git.md','/guide/interview/broswer.md','/guide/interview/miniprogrammer.md','/guide/interview/Vue.md']
    }
  ]
}
